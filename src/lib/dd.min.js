  ...
  class t {
    constructor(e, t) {
      (this.ele = e),
        ...
        (this._isList || 'true' === this._enableCheckbox.toString()) && (this._isMultiple = this.ele.multiple = !0),
    ...
    _init() {
      this._makeLayout(),
        ...
        null !== this._settings.childWidth && (this._wrapper.listOfItems.style.width = this._settings.childWidth),
    ...
    _makeLayout() {
      ...
      s.setAttribute('style', o),
        null !== this._settings.byJson.data && s.setAttribute('style', `width:${this._settings.byJson.width}px`);
    ...
    _createRow(e) {
      ...
      return (
        l.appendChild(a),
        s.appendChild(l),
        e.isDisabled ? s.classList.add(this._css.itemDisabled) : e.isOptGroup || s.classList.add(this._css.itemEnabled),
    ...
    _setSelectedByItem(e, t = !1, s = !0) {
      if (t && e) e.classList.add(this._css.itemSelected);
        ...
        let t = e.index;
        !0 === s ? (this._removeOldSelected(), (this.ele.selectedIndex = t)) : (this.ele.options[t].selected = !0),
    ...
    _updateHeaderUI(e = null, t = null) {
      ...
      if (
        ('true' === this._settings.showPlusItemCounter.toString() &&
          null !== s.ui &&
          s.ui.length > 1 &&
          (l.innerHTML = l.innerHTML + `<span class="${this._css.headerCounter}">&nbsp; (+${s.ui.length - 1})</span>`),
    ...
    next() {
      ...
      if (((e = this._isFilterApplied ? this._nexPrevCounter : this.selectedIndex), i > 0)) {
        let l = (function () {
          ...
          for (; l < i; l++) {
            let e = l + 1;
            if (((e = e >= i ? i - 1 : e), t._nexPrevCounter++, !s[e].classList.contains(t._css.itemDisabled)))
              return s[e];
          }
          return null;
        })();
    ...
    visible(e = null) {
      if (
        (!0 === e ? this._show(this._wrapper.holder, 'inline-block') : !1 === e && this._hide(this._wrapper.holder),
        null === e)
      )
    ...
    set disabled(e) {
      e
        ...
        : (this.ele.removeAttribute('disabled'), this._wrapper.holder.classList.remove(this._css.wrapperDisabled));
    }
    get form() {
